...
@Component({
  selector: 'app-add-associacao',
  templateUrl: './add-aberta-associacao.html',
  styleUrl: '../add-questoes.scss' 
  
})
export class AppAddAssociacaoComponent implements OnInit{
  ...
  afirmaPosition: '1' | '2' | '3' |'4' | '5';
  afirma2Position: '1' | '2' | '3' |'4' | '5';
